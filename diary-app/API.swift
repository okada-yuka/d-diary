...
public struct CreateTodoInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, place: String, price: Int? = nil) {
    graphQLMap = ["id": id, "place": place, "price": price]
  }
...
public struct ModelTodoConditionInput: GraphQLMapConvertible {
  ...
  public init(place: ModelStringInput? = nil, price: ModelIntInput? = nil, and: [ModelTodoConditionInput?]? = nil, or: [ModelTodoConditionInput?]? = nil, not: ModelTodoConditionInput? = nil) {
    graphQLMap = ["place": place, "price": price, "and": and, "or": or, "not": not]
  }
...
public struct UpdateTodoInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, place: String? = nil, price: Int? = nil) {
    graphQLMap = ["id": id, "place": place, "price": price]
  }
...
public struct ModelTodoFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelIDInput? = nil, place: ModelStringInput? = nil, price: ModelIntInput? = nil, and: [ModelTodoFilterInput?]? = nil, or: [ModelTodoFilterInput?]? = nil, not: ModelTodoFilterInput? = nil) {
    graphQLMap = ["id": id, "place": place, "price": price, "and": and, "or": or, "not": not]
  }
...
public final class CreateTodoMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateTodo: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, place: String, price: Int? = nil, createdAt: String, updatedAt: String) {
        self.init(snapshot: ["__typename": "Todo", "id": id, "place": place, "price": price, "createdAt": createdAt, "updatedAt": updatedAt])
      }
