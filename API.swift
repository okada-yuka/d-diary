...
public struct CreateWeightInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, weight: Int? = nil, userId: GraphQLID) {
    graphQLMap = ["id": id, "weight": weight, "userID": userId]
  }
...
public struct ModelWeightConditionInput: GraphQLMapConvertible {
  ...
  public init(weight: ModelIntInput? = nil, userId: ModelIDInput? = nil, and: [ModelWeightConditionInput?]? = nil, or: [ModelWeightConditionInput?]? = nil, not: ModelWeightConditionInput? = nil) {
    graphQLMap = ["weight": weight, "userID": userId, "and": and, "or": or, "not": not]
  }
...
public struct UpdateWeightInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, weight: Int? = nil, userId: GraphQLID? = nil) {
    graphQLMap = ["id": id, "weight": weight, "userID": userId]
  }
...
public struct CreateMealInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID? = nil, userId: GraphQLID, timing: String, place: String, price: Int? = nil, cal: Int? = nil) {
    graphQLMap = ["id": id, "userID": userId, "timing": timing, "place": place, "price": price, "cal": cal]
  }
...
public struct ModelMealConditionInput: GraphQLMapConvertible {
  ...
  public init(userId: ModelIDInput? = nil, timing: ModelStringInput? = nil, place: ModelStringInput? = nil, price: ModelIntInput? = nil, cal: ModelIntInput? = nil, and: [ModelMealConditionInput?]? = nil, or: [ModelMealConditionInput?]? = nil, not: ModelMealConditionInput? = nil) {
    graphQLMap = ["userID": userId, "timing": timing, "place": place, "price": price, "cal": cal, "and": and, "or": or, "not": not]
  }
...
public struct UpdateMealInput: GraphQLMapConvertible {
  ...
  public init(id: GraphQLID, userId: GraphQLID? = nil, timing: String? = nil, place: String? = nil, price: Int? = nil, cal: Int? = nil) {
    graphQLMap = ["id": id, "userID": userId, "timing": timing, "place": place, "price": price, "cal": cal]
  }
...
public struct ModelWeightFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelIDInput? = nil, weight: ModelIntInput? = nil, userId: ModelIDInput? = nil, and: [ModelWeightFilterInput?]? = nil, or: [ModelWeightFilterInput?]? = nil, not: ModelWeightFilterInput? = nil) {
    graphQLMap = ["id": id, "weight": weight, "userID": userId, "and": and, "or": or, "not": not]
  }
...
public struct ModelMealFilterInput: GraphQLMapConvertible {
  ...
  public init(id: ModelIDInput? = nil, userId: ModelIDInput? = nil, timing: ModelStringInput? = nil, place: ModelStringInput? = nil, price: ModelIntInput? = nil, cal: ModelIntInput? = nil, and: [ModelMealFilterInput?]? = nil, or: [ModelMealFilterInput?]? = nil, not: ModelMealFilterInput? = nil) {
    graphQLMap = ["id": id, "userID": userId, "timing": timing, "place": place, "price": price, "cal": cal, "and": and, "or": or, "not": not]
  }
...
public final class CreateUserMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateUser: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, name: String, weights: Weight? = nil, meals: Meal? = nil, createdAt: String, updatedAt: String) {
        self.init(snapshot: ["__typename": "User", "id": id, "name": name, "weights": weights.flatMap { $0.snapshot }, "meals": meals.flatMap { $0.snapshot }, "createdAt": createdAt, "updatedAt": updatedAt])
      }
      ...
      public struct Weight: GraphQLSelectionSet {
        ...
        public struct Item: GraphQLSelectionSet {
          ...
          public init(id: GraphQLID, weight: Int? = nil, userId: GraphQLID, createdAt: String, updatedAt: String) {
            self.init(snapshot: ["__typename": "Weight", "id": id, "weight": weight, "userID": userId, "createdAt": createdAt, "updatedAt": updatedAt])
          }
      ...
      public struct Meal: GraphQLSelectionSet {
        ...
        public struct Item: GraphQLSelectionSet {
          ...
          public init(id: GraphQLID, userId: GraphQLID, timing: String, place: String, price: Int? = nil, cal: Int? = nil, createdAt: String, updatedAt: String) {
            self.init(snapshot: ["__typename": "Meal", "id": id, "userID": userId, "timing": timing, "place": place, "price": price, "cal": cal, "createdAt": createdAt, "updatedAt": updatedAt])
          }
...
public final class CreateWeightMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateWeight: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, weight: Int? = nil, userId: GraphQLID, user: User? = nil, createdAt: String, updatedAt: String) {
        self.init(snapshot: ["__typename": "Weight", "id": id, "weight": weight, "userID": userId, "user": user.flatMap { $0.snapshot }, "createdAt": createdAt, "updatedAt": updatedAt])
      }
...
public final class CreateMealMutation: GraphQLMutation {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct CreateMeal: GraphQLSelectionSet {
      ...
      public init(id: GraphQLID, userId: GraphQLID, user: User? = nil, timing: String, place: String, price: Int? = nil, cal: Int? = nil, createdAt: String, updatedAt: String) {
        self.init(snapshot: ["__typename": "Meal", "id": id, "userID": userId, "user": user.flatMap { $0.snapshot }, "timing": timing, "place": place, "price": price, "cal": cal, "createdAt": createdAt, "updatedAt": updatedAt])
      }
